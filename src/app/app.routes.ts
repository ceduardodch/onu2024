...
export const appRoutes: Route[] = [
    ...
    },
    {
        ...
        children: [
            ...
            {path: 'anios/all', loadChildren: () => import('app/modules/admin/anio/anio.routes')},
            {path: 'cupos', loadChildren: () => import('app/modules/admin/cupo/cupo.routes')},
            {path: 'gruposusts/all', loadChildren: () => import('app/modules/admin/gruposust/gruposust.routes')},
            {path: 'proveedors/all', loadChildren: () => import('app/modules/admin/proveedor/proveedor.routes')},
            {path: 'sustancias/all', loadChildren: () => import('app/modules/admin/sustancia/sustancia.routes')},
