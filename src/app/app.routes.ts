...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'grupo_susts', loadChildren: () => import('app/modules/admin/grupo-sust/grupo-sust.routes')},
            ...
            {path: 'inventorys', loadChildren: () => import('app/modules/admin/inventory/inventory.routes')},
